...
using VersInformer.Service.Concrete;

namespace VersInformer.Service.Host
{ 
    public partial class MainWindow : Window
    {
        ...
        private void buttonStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            Uri tcpAdrs = new Uri("net.tcp://" + textBoxIP.Text.ToString() + ":" + 
                textBoxPort.Text.ToString() + "/VersInformerServiceHost/");

            Uri httpAdrs = new Uri("http://" + textBoxIP.Text.ToString() + ":" +
                (int.Parse(textBoxPort.Text.ToString()) + 1).ToString() + "/VersInformerServiceHost/");

            Uri[] baseAdresses = { tcpAdrs, httpAdrs };

            host = new ServiceHost(typeof(VersInformerService), baseAdresses);
            ...
            host.AddServiceEndpoint(typeof(IVersInformer), tcpBinding, "tcp");
            ...
            host.AddServiceEndpoint(typeof(IMetadataExchange),
                ...
                (int.Parse(textBoxPort.Text.ToString()) - 1).ToString() + "/VersInformerServiceHost/mex");
