...
namespace VersInformer.Forms.Controls
{
    public partial class UserNotifyForm: Form
    {
        #region Public Variables
		/// <summary>
		/// Gets or sets the title text to be displayed in the UserNotifyForm.
		/// </summary>
		public string Title;
		/// <summary>
		...
		/// <summary>
		/// Gets or sets the style used when drawing the background of the UserNotifyForm.
		/// </summary>
		public BackgroundStyles BackgroundStyle;
		/// <summary>
		/// Gets or sets the Blend used when drawing a gradient background for the UserNotifyForm.
		/// </summary>
		public System.Drawing.Drawing2D.Blend Blend;
		/// <summary>
		/// Gets or sets the StringFormat used when drawing text in the UserNotifyForm.
		/// </summary>
		...
		/// of the UserNotifyForm.
		/// </summary>
		public bool WaitOnMouseOver;
		/// <summary>
		/// An EventHandler called when the UserNotifyForm main text is clicked.
		/// </summary>
		public event System.EventHandler TextClicked;
		/// <summary>
		/// An EventHandler called when the UserNotifyForm title text is clicked.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the color of the UserNotifyForm main text.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the amount of milliseconds to display the UserNotifyForm for.
		/// </summary>
		public int WaitTime;
		/// <summary>
		/// Gets or sets the full height of the UserNotifyForm, used after the opening animation has been completed.
		/// </summary>
		public int ActualHeight;
		/// <summary>
		/// Gets or sets the full width of the UserNotifyForm.
		/// </summary>
		...
		#region Constructor
		/// <param name="title">Title text displayed in the UserNotifyForm</param>
		/// <param name="text">Main text displayedin the UserNotifyForm</param>
		public UserNotifyForm (string title, string text) : this() { Title = title; Text = text; }
		/// <param name="text">Text displayed in the UserNotifyForm</param>
		public UserNotifyForm (string text) : this() { Text = text; }
		...
		/// <summary>
		/// Sets the width and height of the UserNotifyForm.
		/// </summary>
